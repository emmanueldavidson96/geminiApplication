...
export default function MetricCard({title, subtitle, value,icon:Icon, onClick}) {
  return (
    <div className="flex flex-col rounded-xl border border-gray-200 shadow-sm dark:border-neutral-800 dark:bg-[#13131a]">
        <div className="flex justify-between gap-x-3 p-4 md:p-5">
            <div>
                ...
                <h3 className="text-xl font-medium text-white sm:text-2xl dark:text-neutral-200">
                    {value}
                </h3>
                </div>
            </div>
