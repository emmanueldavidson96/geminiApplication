...
function SingleRecordDetails() {
  ...
  const handleFileUpload = async () => {
    ...
    try {
      ...
      const prompt = `You are an Resume analyser and my Resume analyser. Use your knowledge base to answer questions about giving personalized recommended recommendations.
        give a detailed learning plan for me, make it more readable, clear and easy to understand make it paragraphs to make it more readable
        `;
  ...
  const processTreatmentPlan = async () => {
    ...
    const prompt = `Your role and goal is to be an that will be using this learning plan ${analysisResult} to create Columns:
                - Todo: Tasks that need to be started
                - Doing: Tasks that are in progress
                - Done: Tasks that are completed
          
                Each task should include a brief description. The tasks should be categorized appropriately based on the stage of the learning process.
